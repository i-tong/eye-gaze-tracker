...
#ifndef CALIBRATIONHEADDIALOG_H
#define CALIBRATIONHEADDIALOG_H
...
class CalibrationHEADDialog : public QDialog
{
    Q_OBJECT
public:
    explicit CalibrationHEADDialog(EyeTracker &tracker);

    ~CalibrationHEADDialog();
